 ...
 */
#[CoversNothing]
final class DeliveryConditionsTest extends TestCase
{
    ...
    public function testRetrieve(): void
    {
        ...
        $result = $this->client->v1->deliveryConditions->retrieve('code');
    ...
    public function testList(): void
    {
        ...
        $result = $this->client->v1->deliveryConditions->list();
