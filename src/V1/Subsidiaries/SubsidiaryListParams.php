 ...
 *
 * @see QbilPhpSDK\Services\V1\SubsidiariesService::list()
 *
 * @phpstan-type SubsidiaryListParamsShape = array{
 *   itemsPerPage?: int|null, page?: int|null
 * }
 */
final class SubsidiaryListParams implements BaseModel
{
    /** @use SdkModel<SubsidiaryListParamsShape> */
    use SdkModel;
    use SdkParams;
