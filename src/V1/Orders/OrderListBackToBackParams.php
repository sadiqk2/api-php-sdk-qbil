 ...
 *
 * @see QbilPhpSDK\Services\V1\OrdersService::listBackToBack()
 *
 * @phpstan-type OrderListBackToBackParamsShape = array{
 *   itemsPerPage?: int|null, page?: int|null
 * }
 */
final class OrderListBackToBackParams implements BaseModel
{
    /** @use SdkModel<OrderListBackToBackParamsShape> */
    use SdkModel;
    use SdkParams;
