 ...
 *
 * @see QbilPhpSDK\Services\V1\OrdersService::listPurchase()
 *
 * @phpstan-type OrderListPurchaseParamsShape = array{
 *   itemsPerPage?: int|null, page?: int|null
 * }
 */
final class OrderListPurchaseParams implements BaseModel
{
    /** @use SdkModel<OrderListPurchaseParamsShape> */
    use SdkModel;
    use SdkParams;
