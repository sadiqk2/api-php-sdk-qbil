 ...
 *
 * @see QbilPhpSDK\Services\V1\OrdersService::listSales()
 *
 * @phpstan-type OrderListSalesParamsShape = array{
 *   itemsPerPage?: int|null, page?: int|null
 * }
 */
final class OrderListSalesParams implements BaseModel
{
    /** @use SdkModel<OrderListSalesParamsShape> */
    use SdkModel;
    use SdkParams;
