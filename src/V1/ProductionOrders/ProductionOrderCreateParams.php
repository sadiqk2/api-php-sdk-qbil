 ...
 *
 * @see QbilPhpSDK\Services\V1\ProductionOrdersService::create()
 *
 ...
 *
 * @phpstan-type ProductionOrderCreateParamsShape = array{
 ...
 * }
 */
final class ProductionOrderCreateParams implements BaseModel
{
    /** @use SdkModel<ProductionOrderCreateParamsShape> */
    use SdkModel;
    use SdkParams;
