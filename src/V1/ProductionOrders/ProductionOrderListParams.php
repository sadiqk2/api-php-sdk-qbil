 ...
 *
 * @see QbilPhpSDK\Services\V1\ProductionOrdersService::list()
 *
 * @phpstan-type ProductionOrderListParamsShape = array{
 *   itemsPerPage?: int|null, page?: int|null
 * }
 */
final class ProductionOrderListParams implements BaseModel
{
    /** @use SdkModel<ProductionOrderListParamsShape> */
    use SdkModel;
    use SdkParams;
