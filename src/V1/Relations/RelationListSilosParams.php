 ...
 *
 * @see QbilPhpSDK\Services\V1\RelationsService::listSilos()
 *
 * @phpstan-type RelationListSilosParamsShape = array{
 *   itemsPerPage?: int|null, page?: int|null
 * }
 */
final class RelationListSilosParams implements BaseModel
{
    /** @use SdkModel<RelationListSilosParamsShape> */
    use SdkModel;
    use SdkParams;
