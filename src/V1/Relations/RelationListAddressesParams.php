 ...
 *
 * @see QbilPhpSDK\Services\V1\RelationsService::listAddresses()
 *
 * @phpstan-type RelationListAddressesParamsShape = array{
 *   itemsPerPage?: int|null, page?: int|null
 * }
 */
final class RelationListAddressesParams implements BaseModel
{
    /** @use SdkModel<RelationListAddressesParamsShape> */
    use SdkModel;
    use SdkParams;
