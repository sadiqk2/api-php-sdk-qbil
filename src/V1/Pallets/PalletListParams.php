 ...
 *
 * @see QbilPhpSDK\Services\V1\PalletsService::list()
 *
 * @phpstan-type PalletListParamsShape = array{
 *   code?: string|null, itemsPerPage?: int|null, page?: int|null
 * }
 */
final class PalletListParams implements BaseModel
{
    /** @use SdkModel<PalletListParamsShape> */
    use SdkModel;
    use SdkParams;
