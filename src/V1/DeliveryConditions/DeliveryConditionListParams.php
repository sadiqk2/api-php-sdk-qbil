 ...
 *
 * @see QbilPhpSDK\Services\V1\DeliveryConditionsService::list()
 *
 * @phpstan-type DeliveryConditionListParamsShape = array{
 *   itemsPerPage?: int|null, page?: int|null
 * }
 */
final class DeliveryConditionListParams implements BaseModel
{
    /** @use SdkModel<DeliveryConditionListParamsShape> */
    use SdkModel;
    use SdkParams;
