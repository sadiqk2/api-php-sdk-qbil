 ...
 *
 * @see QbilPhpSDK\Services\V1\ContainerOrdersService::update()
 *
 * @phpstan-import-type ContainerOrderLineShape from \QbilPhpSDK\V1\ContainerOrders\ContainerOrderLine
 *
 * @phpstan-type ContainerOrderUpdateParamsShape = array{
 *   id?: string|null,
 ...
 * }
 */
final class ContainerOrderUpdateParams implements BaseModel
{
    /** @use SdkModel<ContainerOrderUpdateParamsShape> */
    use SdkModel;
    use SdkParams;
