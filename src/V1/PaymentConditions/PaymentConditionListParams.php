 ...
 *
 * @see QbilPhpSDK\Services\V1\PaymentConditionsService::list()
 *
 * @phpstan-type PaymentConditionListParamsShape = array{
 *   id?: string|null, itemsPerPage?: int|null, page?: int|null
 * }
 */
final class PaymentConditionListParams implements BaseModel
{
    /** @use SdkModel<PaymentConditionListParamsShape> */
    use SdkModel;
    use SdkParams;
